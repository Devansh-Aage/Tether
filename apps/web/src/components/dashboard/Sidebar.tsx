        ...
        <div className='w-16 h-full font-nunito bg-cyan-300 dark:bg-cyan-950 flex flex-col justify-between items-center'>
            <div className=''>
                ...
                <div className='flex flex-col gap-3 '>
                    <SideLink to="/dashboard/add-friend" icon={<UserPlus size={20} />} text='Add Friend' />
                    ...
                    isLoading ?
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                                ...
                                <DropdownMenuGroup>
                                    <Button onClick={logout} size="sm" className='bg-red-500 hover:bg-red-700 text-white w-full'>
                                        Sign out
                                    </Button>
                                </DropdownMenuGroup>
                            </DropdownMenuContent>
