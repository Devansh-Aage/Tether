...
type FormData = z.infer<typeof loginUser>
...
const Login: FC<LoginProps> = ({ }) => {
    ...
    if (errAuthParams) {
        toast.error("Please log in using Email and Password")
    }
    ...
    const onSubmit = async (data: FormData) => {
        try {
            const res = await fetch(`${import.meta.env.VITE_HTTP_URL}auth/login`, {
                method: "POST",
                headers: {
            ...
            <div className=' flex justify-center'>
                <div className=' max-w-lg  flex flex-col gap-3'>
                    ...
                    <div className='flex items-center gap-3 mt-5 justify-center'>
                        ...
                        <NavLink to="/auth/signup" className="text-blue-600 hover:underline-offset-2 hover:underline transition-all duration-100 " >Sign up</NavLink>
                    </div>
                </div>
            </div>
        </AuthLayout>
