export const ADD_FRIEND = "send_friend_req";
export const INCOMING_FRIEND_REQUEST = "incoming_friend_req";
export const FRIEND_REQUEST_RESPONSE = "friend_req_res";

export const ACCEPT_FRIEND_REQ = "accept_friend_req";
export const ACCEPT_FRIEND_RESPONSE = "accept_friend_res";
